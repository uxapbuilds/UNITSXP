...
public class UnitConversionFragment extends Fragment implements View.OnClickListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if(view!=null){
            ...
            //SET INITIAL CARDS
            List<CarouselPicker.PickerItem> textItems = new CarouselData().getUnitArray(conversionType);
            if(textItems.size()>0) {
    ...
    private void showUnitsChooserDialog(String conversionType, String convToFrom) {
        List<CarouselPicker.PickerItem> textItems = new CarouselData().getUnitArray(conversionType);
        if(textItems.size()>0){
